...
#def predict():
    ...
    # Vectorize the preprocessed text data using the TfidfVectorizer model
    #text_vectorized = transform_model.transform([text])
    ...
    #if prediction == 0:
        #return render_template('index.html', prediction='This is a fake news article')
    #else:
       # return render_template('index.html', prediction='This is a real news article')
